...
export function PortabilityGraphic() {
  ...
  return <svg viewBox="0 0 560 300" className="h-auto w-full overflow-visible" role="img" aria-label="ALVIRA knowledge files connect to ChatGPT, Claude, Gemini, Cursor, and your stack.">
    ...
    <text x="24" y="28" className="font-mono text-warm-gray/90" fontSize="10" letterSpacing=".12em" fill="currentColor">PORTABLE BY DESIGN</text>
    ...
    <text x="280" y="284" textAnchor="middle" className="pg-fade font-mono" fontSize="10" letterSpacing=".12em" fill="var(--color-warm-gray)" fillOpacity=".85" style={{ animationDelay: "1.3s" }}>ONE PROFILE · EVERY AI TOOL</text>
  </svg>;
}
