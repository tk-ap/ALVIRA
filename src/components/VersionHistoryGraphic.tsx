...
export function VersionHistoryGraphic() {
  ...
  return (
    <svg
      ...
      role="img"
      aria-label="Illustration of a planned version history timeline showing four AI profile versions from January 2025 to now."
    >
      ...
      <path
        d="M68 103 H492"
        pathLength="1"
        className="vh-line text-warm-gray/45"
        fill="none"
        stroke="currentColor"
        strokeWidth="1"
      ...
      />
      <path
        d="M68 103 C180 103 210 121 294 103 S410 88 492 103"
        pathLength="1"
        className="vh-line text-system/60"
        fill="none"
        stroke="currentColor"
        strokeWidth="1"
        strokeDasharray="5 5"
        ...
        return (
          ...
          >
            <circle
              ...
              cy="103"
              r={current ? 8 : 6}
              fill={current ? "var(--color-system)" : "var(--color-ink-light)"}
              stroke={
                current ? "var(--color-system-dark)" : "var(--color-warm-gray)"
              }
              strokeWidth="1.2"
            />
            <circle
              ...
              r="2"
              fill={
                current ? "var(--color-ink-light)" : "var(--color-warm-gray)"
              }
            />
            <text
              x={x}
              ...
              className="font-mono"
              fontSize="10"
              fill={current ? "var(--color-system)" : "var(--color-warm-gray)"}
            >
              {item.version}
            </text>
            <text
      ...
      <g className="vh-fade" style={{ animationDelay: "1.05s" }}>
        <path
          d="M492 65v-18h20"
          fill="none"
