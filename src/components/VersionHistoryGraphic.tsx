...
export function VersionHistoryGraphic() {
  ...
  return <svg viewBox="0 0 560 250" className="h-auto w-full overflow-visible" role="img" aria-label="Illustration of a planned version history timeline showing four AI profile versions from January 2025 to now.">
    ...
    <text x="280" y="228" textAnchor="middle" className="vh-fade font-mono" fontSize="8" letterSpacing=".18em" fill="var(--color-warm-gray)" fillOpacity=".65" style={{ animationDelay: "1.2s" }}>VERSION HISTORY · COMING SOON</text>
  </svg>;
}
