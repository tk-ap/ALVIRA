...
import { getKnowledgeGraph, type Message, type Tier } from "~/routes/-knowledgeGraph";
...
export function normalizeInterviewLabInput(data: unknown): InterviewLabTurnInput {
  const input = data as {
    tier?: unknown;
    domainId?: unknown;
    history?: unknown;
