...
function ThemeToggle() {
  ...
  return (
    <button type="button" onClick={toggle} className="min-h-11 min-w-11 rounded-lg p-2 text-gray-500 hover:text-gray-700 dark:text-gray-400 dark:hover:text-gray-200 transition-colors focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-system dark:focus-visible:outline-system" aria-label={dark ? "Switch to light mode" : "Switch to dark mode"}>
      {dark ? (
