  ...
  useEffect(() => {
    ...
    getCurrentUser().then(async (u) => {
      ...
      if (u) {
        ...
        // Authenticated users must prefer the account draft. A browser-local
        // smoke/anonymous draft can otherwise mask an older server-autosaved
        // interview after login or a production-domain migration.
