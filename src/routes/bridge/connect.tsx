...
const BRIDGE_URL = process.env.BRIDGE_PUBLIC_URL || "https://alviratech-bridge.vercel.app";
      ...
      <main id="main-content" className="flex-1 flex items-center justify-center px-6 py-16">
        <section className="mx-auto w-full max-w-lg rounded-2xl border border-gray-200 bg-white p-8 shadow-sm dark:border-gray-700 dark:bg-gray-900">
          ...
          <p className="mt-4 leading-7 text-gray-600 dark:text-gray-400">
            Bridge can read your existing ALVIRA Profile so it can distribute your context to connected AI tools. It does not rebuild or replace your Context Engine.
          </p>
          ...
          <a href={authorizeUrl} className="mt-7 inline-flex w-full items-center justify-center rounded-lg bg-system-dark px-5 py-3.5 font-semibold text-white transition hover:opacity-90 dark:bg-system">
            Authorize Bridge →
          </a>
          <a href="https://alviratech-bridge.vercel.app/" className="mt-4 block text-center font-mono text-sm text-system-dark underline dark:text-system">Back to Bridge</a>
        </section>
      </main>
      <TrustFooter />
    </div>
