      ...
      <main id="main-content" className="flex-1 px-6 py-14">
        <div className="mx-auto max-w-5xl">
          ...
          <section className="mt-10 border border-system/30 bg-system-soft/20 p-6 dark:bg-ink/20">
            ...
            <p className="mt-3 max-w-2xl text-sm leading-6 text-gray-600 dark:text-gray-400">Only connections explicitly granted proposal permission can submit candidates. Proposals stay pending until you approve or reject them; read access alone never grants this ability.</p>
          ...
          <p className="mt-8 text-xs leading-5 text-gray-500 dark:text-gray-400">{profiles.length} saved {profiles.length === 1 ? "Context is" : "Contexts are"} available for Bridge. Connected tools cannot silently change ALVIRA's source Context. A separately authorized proposal scope may submit candidates for your review.</p>
        </div>
      </main>
      <TrustFooter />
    </div>
