...
function OwnerDashboard({ metrics }: { metrics: OwnerMetrics }) {
  ...
  return <div className="mb-10 space-y-8">
    ...
    <section><h2 className="mb-3 font-mono text-sm font-semibold uppercase tracking-wide text-gray-500 dark:text-gray-400">Funnel — core events (7d / 30d)</h2><div className="overflow-x-auto border border-gray-200 dark:border-gray-700"><table className="w-full text-left text-sm"><thead className="bg-[#f7f1e8] font-mono text-xs text-gray-600 dark:bg-gray-800 dark:text-gray-400"><tr><th className="px-4 py-3">Event</th><th className="px-4 py-3">Last 7 days</th><th className="px-4 py-3">Last 30 days</th></tr></thead><tbody>{([
