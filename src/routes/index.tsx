  ...
  return (
    <div className="min-h-dvh flex flex-col">
      ...
      <main id="main-content" className="flex-1 flex flex-col">
        ...
        <section className="flex-1 flex flex-col items-center justify-center px-6 py-20 sm:px-8 sm:py-28 lg:py-32">
          <div className="mx-auto max-w-5xl text-center w-full">
            ...
            <p className="mt-6 sm:mt-8 text-base leading-relaxed text-warm-gray-dark dark:text-warm-gray sm:text-lg max-w-2xl mx-auto">
              A 10–15 minute guided interview uncovers how you think, work, and
              decide — then compiles it into a portable AI profile for ChatGPT,
          ...
          <div className="mx-auto max-w-5xl">
            <div className="mx-auto max-w-3xl text-center">
              ...
              <p className="mt-5 text-base leading-relaxed text-gray-600 dark:text-gray-400 sm:text-lg">
                ALVIRA turns your own words into context you can inspect, edit,
                and use immediately—not a hidden memory you have to trust.
              </p>
            </div>
            ...
            <div className="mt-12 grid gap-4 lg:grid-cols-3">
              <article className="rounded-lg border border-gray-200 bg-white p-5 dark:border-gray-700 dark:bg-gray-950">
                ...
                <p className="mt-4 text-sm leading-relaxed text-gray-700 dark:text-gray-300">
                  “For reversible decisions, I prefer to move quickly and learn.
                  For bigger calls, I want input from two people I trust.”
                </p>
              </article>
              ...
              <article className="rounded-lg border border-gray-200 bg-white p-5 dark:border-gray-700 dark:bg-gray-950">
                ...
                <p className="mt-4 text-sm leading-relaxed text-gray-700 dark:text-gray-300">
                  “This choice is reversible, so here is a fast recommendation
                  and the signal that would tell you to change course.”
                </p>
              </article>
            </div>
            ...
            <div className="mt-8 flex flex-col items-center justify-center gap-3 sm:flex-row">
              <a
                href="/samples/alvira-sample-profile.md"
                download
              ...
              <a
                href="/interview#portable"
                className="inline-flex min-h-11 items-center justify-center px-4 py-2.5 font-mono text-xs text-emerald-700 underline underline-offset-4 hover:text-emerald-600 focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-emerald-600 dark:text-emerald-400 dark:hover:text-emerald-300"
              >
                See how to use it →
              </a>
            </div>
            <p className="mt-3 text-center font-mono text-xs text-gray-500 dark:text-gray-400">
              Sample content · Your profile reflects your own words
            </p>
          </div>
        </section>
          ...
          <div className="mx-auto max-w-4xl text-center">
            <div className="mx-auto max-w-4xl">
              ...
              <p className="mt-6 text-base leading-relaxed text-gray-600 dark:text-gray-400 sm:text-lg">
                Every new chat starts the same way: your AI doesn't know how you
                think or how you want it to help. ALVIRA finds that context once
            ...
            <div className="mt-20 grid gap-x-16 gap-y-14 sm:grid-cols-2">
              {[
                [
                  ...
                  "No more retyping your background, goals, and working style into every new chat. Keep instructions in one organized AI profile.",
                ],
                [
                  "Discover context you'd have missed",
                  "Adaptive interviews surface knowledge and patterns you wouldn't think to tell an AI on your own.",
                ],
                [
                  "Stays current as you change",
                  "Update your profile anytime instead of rebuilding from scratch. Your knowledge evolves with you.",
                ],
                [
                  "Get answers shaped around you",
                  "When your AI knows how you think and decide, every answer is more relevant and personal.",
                ],
              ].map(([headline, body], index) => (
                <div
                  key={headline}
                  className="border-t border-gray-200 pt-5 text-left dark:border-gray-800"
                >
        ...
        <section className="border-t border-gray-100 bg-white px-6 py-20 dark:border-gray-800 dark:bg-gray-950 sm:px-8 sm:py-24">
          <div className="mx-auto max-w-4xl text-center">
            <div className="max-w-3xl">
              ...
              <p className="mt-6 text-base leading-relaxed text-gray-600 dark:text-gray-400 sm:text-lg">
                ALVIRA turns a conversation into practical context your AI can
                actually use — not a vague personality summary.
              </p>
            </div>

            <div className="mt-16 overflow-hidden border-y border-gray-200 bg-gray-950 dark:border-gray-700">
              <div
                className="flex overflow-x-auto border-b border-gray-800 bg-gray-900"
                role="tablist"
                aria-label="Example profile files"
              >
              ...
              <div
                className="min-h-[16rem] p-5 sm:p-8"
                id="profile-preview-panel"
                role="tabpanel"
                aria-labelledby={`profile-tab-${activePreview}`}
              >
            ...
            <div className="mt-24 grid items-center gap-14 border-t border-gray-200 pt-12 dark:border-gray-800  lg:grid-cols-[0.8fr_1.2fr]">
              <div>
                ...
                <h3 className="mt-3 text-2xl font-bold text-gray-900 dark:text-gray-100">
                  Your AI profile grows with you.
                </h3>
                <p className="mt-3 max-w-xl text-base leading-relaxed text-gray-600 dark:text-gray-400">
                  Keep your context current as your work, priorities, and
                  preferences evolve. A visible version history of your updates
                  is coming soon.
                </p>
              </div>
        ...
        <section className="border-t border-gray-100 bg-gray-50 px-6 py-20 dark:border-gray-800 dark:bg-gray-900 sm:px-8 sm:py-24">
          <div className="mx-auto max-w-4xl text-center">
            <div className="mx-auto max-w-4xl">
              ...
              <p className="mt-6 text-base leading-relaxed text-gray-600 dark:text-gray-400 sm:text-lg">
                Most AI platforms turn your context into lossy model-generated
                prose. ALVIRA builds structured, user-owned Markdown files that
                work everywhere and stay current.
              </p>
            </div>
            ...
            <div className="mt-24 flex flex-col items-center border-t border-gray-200 pt-14 dark:border-gray-800">
              <div>
                ...
                <p className="mt-3 max-w-md text-base leading-relaxed text-gray-600 dark:text-gray-400">
                  Open Markdown keeps your knowledge useful across the tools you
                  already use — and the ones you have not met yet.
                </p>
              </div>
        ...
        <section className="border-t border-gray-100 bg-white px-6 py-20 dark:border-gray-800 dark:bg-gray-950 sm:px-8 sm:py-24">
          <div className="mx-auto max-w-4xl text-center">
            <div className="max-w-3xl">
              ...
              <p className="mt-6 text-base leading-relaxed text-gray-600 dark:text-gray-400 sm:text-lg">
                Start free — no credit card, no time limit. When ALVIRA becomes
                part of how you work, upgrade for more profiles and continuous
                updates.
              </p>
            </div>
            ...
            <div className="mt-14 max-w-2xl border-y border-emerald-500/40 py-8 dark:border-emerald-400/30 sm:py-10">
              <div>
                ...
                <p className="mt-3 text-center">
                  <a
                    href="/pricing"
                    className="font-mono text-xs text-gray-500 hover:text-emerald-700 dark:text-gray-400 dark:hover:text-emerald-400 transition-colors focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-emerald-600 dark:focus-visible:outline-emerald-400"
                  >
                    Compare plans →
                  </a>
                </p>
        ...
        <section
          id="privacy"
          className="border-t border-gray-100 bg-white px-6 py-20 dark:border-gray-800 dark:bg-gray-950 sm:px-8 sm:py-24"
        >
          <div className="mx-auto max-w-4xl text-center">
            <div className="max-w-3xl">
              <span className="font-mono text-xs uppercase tracking-wide text-emerald-700 dark:text-emerald-400">
              ...
              <p className="mt-5 max-w-2xl text-base leading-relaxed text-gray-600 dark:text-gray-400 sm:text-lg">
                You should never have to wonder where the most personal context
                about you goes. ALVIRA is designed around ownership and control
                from the start.
              </p>
            </div>
            ...
            <div className="mt-12 grid gap-x-12 gap-y-10 sm:grid-cols-2">
              {[
                [
                  "01",
                  "Secure storage",
                  "Your interviews and profiles are stored securely on ALVIRA's servers. Export them as Markdown files anytime — the files are yours to keep and take anywhere.",
                ],
                [
                  "02",
                  "No training",
                  "We never use your knowledge to train AI models. Your answers are processed by OpenAI's API for question generation — they do not train on your data. Your data belongs to you: export or delete it anytime.",
                ],
                [
                  "03",
                  "Portable format",
                  "Open Markdown means no vendor lock-in. Read, edit, and use your files with any tool.",
                ],
                [
                  "04",
                  "You control sharing",
                  "Share files with specific AI tools or team members, or keep them completely private. Your data is never shared or sold — there's nothing to opt out of.",
                ],
              ].map(([number, title, body]) => (
                <div
                  key={title}
                  className="border-l-2 border-emerald-200 pl-4 text-left dark:border-emerald-800"
                >
                  <div className="flex items-start gap-4">
                    <span
                      className="font-mono text-xs font-semibold text-emerald-700 dark:text-emerald-400"
                      aria-hidden="true"
                    >
                      {number}
                    </span>
              ...
              {[
                {
                  ...
                  answer:
                    "ALVIRA builds portable, editable Markdown files you own — not hidden memory tied to one platform. You can inspect, update, and take your profile anywhere.",
                },
                {
                  question: "What happens to my data?",
                  answer:
                    "Your data is stored on ALVIRA's servers and never used to train AI models. You can export it as Markdown files you control at any time.",
                },
                {
                  question: "Can I use this with Claude, Gemini, or Cursor?",
                  answer:
                    "Yes. Markdown works everywhere, so you can copy-paste your profile into Claude, Gemini, Cursor, ChatGPT, or any other AI tool.",
                },
                {
                  question: "How long does an interview take?",
                  answer:
                    "About 10–15 minutes gives you a solid foundation. Return anytime to go deeper or update your profile as things change.",
                },
                {
                  question: "Is there a free plan?",
                  answer:
                    "Yes: 1 profile, 3 interviews, and all 19 knowledge domains — with no credit card required.",
                },
                {
                  question:
                    "What's the difference between ALVIRA Personal and MeOS?",
                  answer:
                    "ALVIRA Personal builds your AI profile. MeOS turns what ALVIRA discovers into a personal operating system for decisions, direction, work, and daily life.",
                },
              ].map((item, index) => {
                ...
                return (
                  ...
                  >
                    ...
                    >
                      ...
                      <span
                        className="shrink-0 font-mono text-xl font-normal text-emerald-700 dark:text-emerald-400"
                        aria-hidden="true"
                      >
                        {isOpen ? "−" : "+"}
                      </span>
                    ...
                    {isOpen && (
                      <p
                        id={`faq-${index}`}
                        className="max-w-2xl pb-5 pr-10 text-base leading-relaxed text-gray-600 dark:text-gray-400"
                      >
                        {item.answer}
                      </p>
                    )}
