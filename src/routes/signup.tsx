...
export const Route = createFileRoute("/signup")({
  head: () => ({
    meta: [
      { title: "Create your ALVIRA profile" },
      {
        name: "description",
        content:
          "Create an ALVIRA account and build the context your AI is missing.",
      },
    ],
  }),
        ...
        <div className="mx-auto w-full max-w-md">
          <div className="text-center mb-10">
            ...
            <p className="mt-2 text-gray-600 dark:text-gray-400">
              Save your interview progress and keep your generated profile —
              free.
            </p>
          </div>
          ...
          <form onSubmit={handleSubmit} className="space-y-5">
            ...
            <div>
              ...
              >
                Use at least 8 characters. Your password is never shown in your
                exported profile.
              </p>
            </div>
          ...
          <p className="mt-4 text-center text-xs leading-relaxed text-gray-500 dark:text-gray-400">
            ...
            . If you started an interview anonymously, this browser&apos;s draft
            will be attached after signup.
          </p>
